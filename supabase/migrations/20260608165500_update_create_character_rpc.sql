-- Migration: Update create_character_rpc to support all character/monster fields (age, height, weight, max_spells, spells, abilities, experience)

-- 1. Drop the previous signature of the function
...
-- 2. Recreate the function with all fields
